...
cand4 = pd.read_csv(
    folder_dir + 'lb_0706_incep_res_0001_idx0_batch500_zoom0_shift0_adam_99-1.3947-0.7928-0.7105.csv.gz',
    compression='gzip')
...
cand6 = pd.read_csv(
    folder_dir + 'lb_07099_xception_0001_idx0_batch960_zoom0_shift0_adam_45-1.1024-0.7602-0.7291.csv.gz',
    compression='gzip')
cand6 = cand6.sort_values('_id', ascending=True)
cand6 = cand6["category_id"]

cand7 = pd.read_csv(folder_dir + 'lb_07170_incep3_0001_idx0_batch960_zoom0_shift0_adam_45-1.1022-0.7960-0.7313.csv.gz',
                    compression='gzip')
