...
if 1:
    for im in tqdm(test_im_batch):
        ...
        cat_idx = np.argmax(predictions, axis=1)
        ...
        del test_images_df_new, predictions
        split = split + 1
...
yy.to_csv('submit/weight_vgg16_f10_Aug.00-1.62117-0.75646-0.67416.csv.gz', index=False, compression='gzip')
