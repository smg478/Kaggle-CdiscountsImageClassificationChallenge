...
save_folder = 'submit/incep_res_70_3modl/'
...
# test_im_batch = (test_images_df_20, test_images_df_21)
...
weight_1_path = 'weights/1.incep_res_idxZero_full_flip_Nadam_drop025_32-1.3625-0.7113-0.7036.hdf5'
weight_2_path = 'weights/incep_res_idxZero_flip_Nadam_drop02_classBal_11-1.4080-0.7473-0.7025.hdf5'
weight_3_path = 'weights/incep_res_idxZero_flip_Nadam_drop02_10-1.3649-0.7167-0.7030.hdf5'

weights_path = [weight_1_path, weight_2_path, weight_3_path]
...
if 1:
    for im in tqdm(test_im_batch):
        ...
        ######################3#################################################################
        for weight_path in tqdm(weights_path):
...
yy.to_csv('submit/incep_res_3modelAve.csv.gz', index=False, compression='gzip')
